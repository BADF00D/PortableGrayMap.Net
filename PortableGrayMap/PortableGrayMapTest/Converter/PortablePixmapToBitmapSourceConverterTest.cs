namespace PortableGrayMapTest.Converter
{
    ...
    [TestFixture]
    internal class PortablePixmapToBitmapSourceConverterTest
    {
        [SetUp]
        public void Setup()
        {
            _convert = new PortablePixmapToBitmapSourceConverter();
        ...
        private IConverter<IPortablePixmap, BitmapSource> _convert;
